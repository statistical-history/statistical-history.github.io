# ============================================================================
# Helper functions for Lab 03: probability, simulation, and certainty
#
# These are the same functions as homework/hw-02/homework_02_helpers.R, shipped
# here so the lab repo is self-contained. Keep them in sync if that file changes.
# ============================================================================
#
