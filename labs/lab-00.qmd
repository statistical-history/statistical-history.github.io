...
- Click **`STA119`** to open the container. You should now see the RStudio environment in your browser, with a **Console** pane showing a `>` prompt.
...
1.  Go to `https://github.com/.../lab-00 [LINK]`.
...
Next week: pull, commit, push, and the first real data — Mayer's 27 equations (`labs/lab-01/`).
